            ...
            <nav class="nav">
                <div>
                    <div class="nav_list">
                        ...
                        <a href="../public/posts/create" class="nav_link">
                            <i class='bx bx-folder nav_icon'></i>
                            <span class="nav_name">FACILITIES</span>
                        </a>
                        <a href="../public/posts/create" class="nav_link">
                            <i class='bx bx-folder nav_icon'></i>
                            <span class="nav_name">RECORDS</span>
                        </a>
                        <a href="../multimedia/create" class="nav_link">
                            <i class='bx bx-user nav_icon'></i>
                            <span class="nav_name">PROFILE UPDATE</span>
                        </a>
                         <a href="#" class="nav_link">
                ...
                *,::before,::after{
                    ...
                    .header{
                        ...
                        .header_toggle{
                            ...
                            .nav_logo-name{color: var(--white-color);font-weight: 700}.nav_link{position: relative;color: var(--first-color-light);margin-bottom: 1.5rem;transition: .3s}
                            .nav_link:hover{color: var(--white-color)}
                            .nav_icon{font-size: 1.25rem}.show{left: 0}.body-pd{padding-left: calc(var(--nav-width) + 1rem)}.active{color: var(--white-color)}
