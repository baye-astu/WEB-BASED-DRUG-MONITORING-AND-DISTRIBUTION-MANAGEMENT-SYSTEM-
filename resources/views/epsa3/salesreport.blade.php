    ...
    <div class="table-responsive px-2">
        <table class="table table-success">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="bg-blight">{{ $sell->id }}</span></td>
                    <td><span class="bg-bdark">{{ $sell->name }}</span></span></td>
                    <td><span class="bg-blight">{{ $sell->unit }}</span></td>
                    <td><span class="bg-blight">{{ $sell->quantity }}</span></td>
                    <td><span class="bg-bdark">{{ $sell->unitprice }}</span></td>
                    <td><span class="bg-bdark">{{ $sell->totalprice }}</span></td>
                </tr>
                @endforeach
            </tbody>
        </table>
